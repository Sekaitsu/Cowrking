...
using OpenTelemetry;
using CoworkingBack.AppServices.Automapper;
...
namespace CoworkingBack.AppServices
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.ConfigurarSwaggerConVersiones(Environment, PlatformServices.Default.Application.ApplicationBasePath, new string[] { "CoworkingBack.AppServices.xml" });
